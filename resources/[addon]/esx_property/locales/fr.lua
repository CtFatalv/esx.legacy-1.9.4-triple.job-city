Locales["fr"] = {
	...
	["no"] = "Non",
	["action"] = "Vous %s ~b~%s~s~ !",
	["bought_furni"] = "Vous avez ~g~acheté~s~ A ~b~%s~s~ !",
	["edited_furni"] = "Vous avez modifié ~b~%s~s~ !",
	["cannot_buy"] = "Vous ~r~ne pouvez pas~s~ acheter ceci !",
	["cannot_edit"] = "Vous ~r~ne pouvez pas~s~ modifier ceci !",
	["store_title"] = "Magasin - %s",
	["back"] = "Retour",
	["edit_title"] = "Modification - %s",
	["move_title"] = "Déplacer",
	["deleted_confirm"] = "Suppression de ~b~%s~s~ !",
	["deleted_error"] = "Impossible de supprimer ~b~%s~s~ !",
	["owned_furni"] = "Meubles possédés",
	...
	["already_has"] = "Ce joueur a déjà des clés !",
	...
	["create_name"] = "propriété:créer",
	["create_desc"] = "Créer une nouvelle propriété",
	["admin_name"] = "propriété:admin",
	...
	["wardrobe_desc"] = "Modifier la position de l\'armoire de propriété.",
	...
	["cannot_raid"] = "Vous ne pouvez pas ~b~Raid~s~ cette propriété.",
	...
	["wardrobe_pos_textui"] = "Appuyez sur ~b~[G]~s~ pour définir la position de la garde -robe",
	["wardrobe_pos_success"] = "~b~Armoire~s~ Définir la position.",
	["wardrobe_pos_error"] = "~r~Impossible~s~ de définir la position de ~b~armoire~s~.",
	["please_finish"] = "Veuillez finir de définir la position ~b~%s~s~",
	["cannot_afford"] = "Vous ne pouvez pas acheter cette propriété !",
	["select_player"] = "Sélectionner un joueur",
	["cannot_sell"] = "Impossible de vendre à ce joueur !",
	...
	["cannot_access"] = "Vous ne pouvez pas accéder à ce garage !",
	...
	["entrance_set_title"] = "Ensemble d entrée.",
