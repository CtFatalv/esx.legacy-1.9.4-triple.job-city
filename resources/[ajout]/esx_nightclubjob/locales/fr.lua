Locales['fr'] = {
    ...
    ['nightclub_fridge_stock']     = 'Frigo du Vanilla nightclub',
    ['fridge_inventory']         = 'Contenu du frigo',

    -- Shops  
    ['shop']                     = 'Boutique du Vanilla nightclub',
    ...
    ['nightclub_stock']            = 'Stock du Vanilla nightclub',
    ...
    -- Misc  
    ['map_blip']                 = 'Vanilla nightclub',
    ['nightclub']                  = 'Vanilla nightclub',

    -- Phone  
    ['nightclub_phone']            = 'nightclub',
    ['nightclub_customer']         = 'Citoyen',
